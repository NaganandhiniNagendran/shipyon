  ...
  return (
    <div className="min-h-screen services-container">
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4 title-hover">Our core services</h2>
          </div>
          <div 
          ...
          >
            ...
            >
              <div className="bg-white p-6 rounded-lg shadow-sm text-center border-2 border-gray-800 flex-shrink-0 transition-all duration-300 hover:shadow-xl hover:scale-105 hover:border-green-600 cursor-pointer" 
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-2 title-hover">Agricultural Product Sourcing</h3>
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm text-center border-2 border-gray-800 flex-shrink-0 transition-all duration-300 hover:shadow-xl hover:scale-105 hover:border-green-600 cursor-pointer" 
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-2 title-hover">Domestic & International Trade</h3>
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm text-center border-2 border-gray-800 flex-shrink-0 transition-all duration-300 hover:shadow-xl hover:scale-105 hover:border-green-600 cursor-pointer" 
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-2 title-hover">Custom Product Procurement</h3>
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm text-center border-2 border-gray-800 flex-shrink-0 transition-all duration-300 hover:shadow-xl hover:scale-105 hover:border-green-600 cursor-pointer" 
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-2 title-hover">Marketing & Sales Support</h3>
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm text-center border-2 border-gray-800 flex-shrink-0 transition-all duration-300 hover:shadow-xl hover:scale-105 hover:border-green-600 cursor-pointer" 
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-2 title-hover">Import & Market Development</h3>
      ...
      <section className="how-we-work-container">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="how-we-work-header">
            <h2 className="how-we-work-title title-hover">How We Work</h2>
          ...
          <div className="how-we-work-grid">
            ...
            <div className="step-card">
              ...
              <h3 className="step-title title-hover">Identify Requirement</h3>
            ...
            <div className="step-card">
              ...
              <h3 className="step-title title-hover">Source & Verify Suppliers</h3>
            ...
            <div className="step-card">
              ...
              <h3 className="step-title title-hover">Quality & Logistics Management</h3>
            ...
            <div className="step-card">
              ...
              <h3 className="step-title title-hover">Delivery & Market Support</h3>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4 title-hover">Our Global Network</h2>
          ...
          <div className="mt-16 mb-12 milestone-section">
            <div className="milestone-container">
              <div className="text-center mb-12">
                <h2 className="text-3xl font-bold text-gray-900 mb-4 underline decoration-4 underline-offset-4 title-hover">Why Shipyon?</h2>
              </div>
